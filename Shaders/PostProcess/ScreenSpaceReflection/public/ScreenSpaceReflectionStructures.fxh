...
#define SSR_DISOCCLUSION_DEPTH_WEIGHT 1.0f

#define SSR_DISOCCLUSION_THRESHOLD 0.9f

#define SSR_TEMPORAL_STANDARD_DEVIATION_SCALE 2.0f

#define SSR_BILATERAL_SIGMA_NORMAL 128

#define SSR_BILATERAL_SIGMA_DEPTH 1
