...
float SmithGGXVisibilityCorrelated(float NdotL, float NdotV, float LinearRoughness)
{
...
float NormalDistribution_GGX(float NdotH, float LinearRoughness)
{
    float a2 = LinearRoughness * LinearRoughness;
          ...
          out float                 NdotL)
{
    ...
    if (angularInfo.NdotL > 0.0 || angularInfo.NdotV > 0.0)
    {
        ...
        float  D   = NormalDistribution_GGX(angularInfo.NdotH, SrfInfo.LinearRoughness);
        float  Vis = SmithGGXVisibilityCorrelated(angularInfo.NdotL, angularInfo.NdotV, SrfInfo.LinearRoughness);
