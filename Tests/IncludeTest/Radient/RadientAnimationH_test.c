...
void RadientAnimation_C_UseTypes(void)
{
    ...
    Schema                                = RadientLightAnimationSchemaID;
    Property                              = RadientLightColorProperty;
    Property                              = RadientLightIntensityProperty;
    Property                              = RadientLightRangeProperty;
    Property                              = RadientLightExposureProperty;
    Property                              = RadientLightInnerConeAngleProperty;
    Property                              = RadientLightOuterConeAngleProperty;
    Property                              = RadientLightDiffuseProperty;
    Property                              = RadientLightSpecularProperty;
    Property                              = RadientLightNormalizeProperty;
    Property                              = RadientLightEnableColorTemperatureProperty;
    Property                              = RadientLightColorTemperatureProperty;
    Property                              = RadientLightRadiusProperty;
    Property                              = RadientLightAngleProperty;
    Property                              = RadientLightShapingFocusProperty;
    Schema                                = RadientCameraAnimationSchemaID;
    Property                              = RadientCameraHorizontalApertureProperty;
    Property                              = RadientCameraVerticalApertureProperty;
    Property                              = RadientCameraFocalLengthProperty;
    Property                              = RadientCameraNearClipProperty;
    Property                              = RadientCameraFarClipProperty;
    Property                              = RadientCameraFStopProperty;
    Property                              = RadientCameraFocusDistanceProperty;
