...
static_assert(RADIENT_MATERIAL_PARAMETER_FLAG_NONE == 0, "Unexpected RADIENT_MATERIAL_PARAMETER_FLAG_NONE value");
static_assert(RADIENT_MATERIAL_PARAMETER_FLAG_SPECIALIZATION == 1, "Unexpected RADIENT_MATERIAL_PARAMETER_FLAG_SPECIALIZATION value");
