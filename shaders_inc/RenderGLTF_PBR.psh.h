...
"float3 getNormal()\n"
"{\n"
"    float2 UV = getNormalUV();\n"
"\n"
"    // Retrieve the tangent space matrix\n"
"#ifndef HAS_TANGENTS\n"
"    float3 pos_dx = dFdx(v_Position);\n"
"    float3 pos_dy = dFdy(v_Position);\n"
"    float3 tex_dx = dFdx(float3(UV, 0.0));\n"
"    float3 tex_dy = dFdy(float3(UV, 0.0));\n"
"    float3 t = (tex_dy.t * pos_dx - tex_dx.t * pos_dy) / (tex_dx.s * tex_dy.t - tex_dy.s * tex_dx.t);\n"
"\n"
"#ifdef HAS_NORMALS\n"
...
"	}\n"
"    \n"
"    float3 TSNormal     = g_NormalMap            .Sample(g_NormalMap_sampler,             lerp(UV0, UV1, g_MaterialInfo.NormalTextureUVSelector)).rgb;\n"
...
"    float3 normal = Normal;//getNormal();\n"
"    float3 view   = normalize(g_CameraAttribs.f4Position.xyz - WorldPos.xyz); // Direction from surface point to camera\n"
"\n"
"    color += ApplyDirectionalLight(g_LightAttribs.f4Direction.xyz, g_LightAttribs.f4Intensity.rgb, SrfInfo, normal, view);\n"
"//color = dot(view, Normal).rrr;\n"
"//    color = view;\n"
"//#ifdef USE_PUNCTUAL\n"
...
"    color = lerp(color, color * Occlusion, u_OcclusionStrength);\n"
"\n"
"    const float u_EmissiveFactor = 1.0f;\n"
"    color += SRGBtoLINEAR(Emissive).rgb * u_EmissiveFactor;\n"
"\n"
