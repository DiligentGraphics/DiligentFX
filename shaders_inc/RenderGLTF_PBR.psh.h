...
"    }\n"
"\n"
"    float3 TSNormal = g_MaterialInfo.NormalTextureUVSelector >= 0.0 ?\n"
"        g_NormalMap.Sample(g_NormalMap_sampler, float3(NormalMapUV, g_MaterialInfo.NormalSlice)).rgb * float3(2.0, 2.0, 2.0) - float3(1.0, 1.0, 1.0) : \n"
"        float3(0.0, 0.0, 1.0);\n"
"\n"
"    float Occlusion = 1.0;\n"
"#if GLTF_PBR_USE_AO\n"
