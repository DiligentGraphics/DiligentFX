...
"\n"
"    float lod = clamp(SrfInfo.LinearRoughness * float(g_RenderParameters.PrefilteredCubeMipLevels), 0.0, float(g_RenderParameters.PrefilteredCubeMipLevels));\n"
"    float3 reflection = normalize(reflect(-v, n));\n"
"\n"
"    float2 brdfSamplePoint = clamp(float2(NdotV, SrfInfo.LinearRoughness), float2(0.0, 0.0), float2(1.0, 1.0));\n"
...
"        perceptualRoughness = (1.0 - PhysicalDesc.a * u_GlossinessFactor); // glossiness to roughness\n"
...
"        perceptualRoughness = PhysicalDesc.g * g_MaterialInfo.RoughnessFactor;\n"
...
"    SrfInfo.LinearRoughness = perceptualRoughness;//perceptualRoughness * perceptualRoughness;\n"
"\n"
"    // Compute reflectance.\n"
...
"			case  5: OutColor.rgb  = metallic.rrr;                    break;\n"
"			case  6: OutColor.rgb  = perceptualRoughness.rrr;         break;\n"
"            case  7: OutColor.rgb  = SrfInfo.DiffuseColor;            break;\n"
"            case  8: OutColor.rgb  = SrfInfo.Reflectance0;            break;\n"
