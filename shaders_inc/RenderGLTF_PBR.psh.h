...
"    float4 BaseColor = g_ColorMap.Sample(g_ColorMap_sampler, float3(BaseColorUV, g_MaterialInfo.BaseColorSlice));\n"
...
"    }\n"
"\n"
"    float3 TSNormal = g_NormalMap.Sample(g_NormalMap_sampler, float3(NormalMapUV, g_MaterialInfo.NormalSlice)).rgb * float3(2.0, 2.0, 2.0) - float3(1.0, 1.0, 1.0);\n"
"\n"
"    float Occlusion = 1.0;\n"
"#if GLTF_PBR_USE_AO\n"
"    {\n"
"        float2 OcclusionUV = GetTextureUV(UV0, UV1, g_MaterialInfo.OcclusionTextureUVSelector, g_MaterialInfo.OcclusionUVScaleBias);\n"
"        Occlusion = g_AOMap.Sample(g_AOMap_sampler, float3(OcclusionUV, g_MaterialInfo.OcclusionSlice)).r;\n"
"    }\n"
"#endif\n"
"\n"
...
"        Emissive = g_EmissiveMap.Sample(g_EmissiveMap_sampler, float3(EmissiveUV, g_MaterialInfo.EmissiveSlice)).rgb;\n"
"    }\n"
"#endif\n"
"\n"
"\n"
...
"    float4 PhysicalDesc = g_PhysicalDescriptorMap.Sample(g_PhysicalDescriptorMap_sampler, float3(PhysicalDescUV, g_MaterialInfo.PhysicalDescriptorSlice));\n"
"    \n"
"    float metallic;\n"
