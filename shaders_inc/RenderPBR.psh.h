...
"{\n"
"    float4 BaseColor = SampleTexture(g_ColorMap, g_ColorMap_sampler, UV0, UV1, g_MaterialInfo.BaseColorTextureUVSelector,\n"
...
"    float Occlusion = 1.0;\n"
"#if PBR_USE_AO\n"
"    Occlusion = SampleTexture(g_AOMap, g_AOMap_sampler, UV0, UV1, g_MaterialInfo.OcclusionTextureUVSelector,\n"
"                              g_MaterialInfo.OcclusionUVScaleBias, g_MaterialInfo.OcclusionSlice, float4(1.0, 1.0, 1.0, 1.0)).r;\n"
"#endif\n"
"\n"
"    float3 Emissive = float3(0.0, 0.0, 0.0);\n"
"#if PBR_USE_EMISSIVE\n"
"    Emissive = SampleTexture(g_EmissiveMap, g_EmissiveMap_sampler, UV0, UV1, g_MaterialInfo.EmissiveTextureUVSelector,\n"
"                             g_MaterialInfo.EmissiveUVScaleBias, g_MaterialInfo.EmissiveSlice, float4(0.0, 0.0, 0.0, 0.0)).rgb;\n"
"#endif\n"
"\n"
"    float4 PhysicalDesc = SampleTexture(g_PhysicalDescriptorMap, g_PhysicalDescriptorMap_sampler,\n"
