...
"                              in  bool     IsFrontFace)\n"
"{\n"
"    float4 BaseColor = GetBaseColor(VSOut, g_PBRAttribs.Material);\n"
"\n"
...
"    }\n"
"\n"
"    float3 TSNormal     = GetMicroNormal(VSOut, g_PBRAttribs.Material, NormalMapUV, dNormalMapUV_dx, dNormalMapUV_dy);\n"
"    float  Occlusion    = GetOcclusion(VSOut, g_PBRAttribs.Material);\n"
"    float3 Emissive     = GetEmissive(VSOut, g_PBRAttribs.Material);\n"
"    float4 PhysicalDesc = GetPhysicalDesc(VSOut, g_PBRAttribs.Material);\n"
"\n"
