...
"    ClearCoatNMUVInfo = GetNormalMapUVInfo(VSOut, ClearCoatNormalTexAttribs);\n"
"#endif\n"
"\n"
...
"    float3 ClearCoatNormal    = GetClearcoatNormal(g_Primitive.Material, ClearCoatNMUVInfo.UV, ClearCoatNMUVInfo.SmoothUV, ClearCoatNMUVInfo.dUV_dx, ClearCoatNMUVInfo.dUV_dy);\n"
"\n"
...
"    {\n"
"        perturbedNormal = PerturbNormal(NormalInfo,\n"
"                                        NMUVInfo.dUV_dx,\n"
"                                        NMUVInfo.dUV_dy,\n"
"                                        TSNormal,\n"
...
"    float3 ClearCoatPerturbedNormal = float3(0.0, 0.0, 0.0);\n"
"#   if ENABLE_CLEAR_COAT\n"
"    {\n"
"        ClearCoatPerturbedNormal = MeshNormal;\n"
"\n"
"#       if USE_CLEAR_COAT_NORMAL_MAP\n"
"        {\n"
...
"            if (ClearCoatNormalTexAttribs.UVSelector >= 0)\n"
"            {\n"
"                ClearCoatPerturbedNormal = PerturbNormal(NormalInfo,\n"
"                                                         ClearCoatNMUVInfo.dUV_dx,\n"
"                                                         ClearCoatNMUVInfo.dUV_dy,\n"
"                                                         ClearCoatNormal,\n"
"                                                         true,\n"
"                                                         IsFrontFace);\n"
"            }\n"
...
"    {\n"
"        OutColor.rgb = abs(ClearCoatPerturbedNormal.xyz);\n"
"    }\n"
