...
"\n"
"    float IsSelected0 = g_SelectionDepth.Load(int3(PSIn.Pos.xy + float2(-1.0, -1.0), 0)).r != 1.0 ? 1.0 : 0.0;\n"
"    float IsSelected1 = g_SelectionDepth.Load(int3(PSIn.Pos.xy + float2(0.0, -1.0), 0)).r != 1.0 ? 1.0 : 0.0;\n"
"    float IsSelected2 = g_SelectionDepth.Load(int3(PSIn.Pos.xy + float2(+1.0, -1.0), 0)).r != 1.0 ? 1.0 : 0.0;\n"
"\n"
"    float IsSelected3 = g_SelectionDepth.Load(int3(PSIn.Pos.xy + float2(-1.0, 0.0), 0)).r != 1.0 ? 1.0 : 0.0;\n"
"    float IsSelected4 = SelectionDepth != 1.0 ? 1.0 : 0.0;\n"
"    float IsSelected5 = g_SelectionDepth.Load(int3(PSIn.Pos.xy + float2(+1.0, 0.0), 0)).r != 1.0 ? 1.0 : 0.0;\n"
"\n"
"    float IsSelected6 = g_SelectionDepth.Load(int3(PSIn.Pos.xy + float2(-1.0, +1.0), 0)).r != 1.0 ? 1.0 : 0.0;\n"
"    float IsSelected7 = g_SelectionDepth.Load(int3(PSIn.Pos.xy + float2(0.0, +1.0), 0)).r != 1.0 ? 1.0 : 0.0;\n"
"    float IsSelected8 = g_SelectionDepth.Load(int3(PSIn.Pos.xy + float2(+1.0, +1.0), 0)).r != 1.0 ? 1.0 : 0.0;\n"
"\n"
