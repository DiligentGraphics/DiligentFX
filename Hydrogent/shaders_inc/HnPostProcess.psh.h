...
"\n"
"    float4 SpecularIBL = g_SpecularIBL.Load(int3(PSIn.Pos.xy, 0));\n"
"    float4 SSRRadiance = g_SSR.Load(int3(PSIn.Pos.xy, 0));\n"
"\n"
...
"        float Dist = length(ClosestSelectedLocation - PSIn.Pos.xy);\n"
