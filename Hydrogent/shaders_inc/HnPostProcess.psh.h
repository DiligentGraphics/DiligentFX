...
"    bool   IsClosestLocationValid = false;\n"
"    DecodeClosestSelectedLocation(g_ClosestSelectedLocation.Load(int3(PSIn.Pos.xy, 0)).xy, ClosestSelectedLocation, IsClosestLocationValid);\n"
"    float Outline = 0.0;\n"
"    if (IsClosestLocationValid)\n"
"    {\n"
"        float Width, Height;\n"
"        g_ColorBuffer.GetDimensions(Width, Height);\n"
"        float Dist = length(ClosestSelectedLocation * float2(Width, Height) - PSIn.Pos.xy);\n"
"        float SelectionOutlineWidth = 4.0;\n"
"        Outline = saturate(1.0 - Dist / SelectionOutlineWidth) * (SelectionDepth != g_Attribs.ClearDepth ? 0.0 : 1.0);\n"
"    }\n"
"\n"
