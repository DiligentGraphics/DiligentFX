...
"    bool   TestLocationValid = false;\n"
"    DecodeClosestSelectedLocation(g_SrcClosestLocation.Load(int3(CurrentLocation + Offset * g_Constants.SampleRange, 0)).xy, TestSelectedLocation, TestLocationValid);\n"
"    if (!TestLocationValid)\n"
"        return;\n"
"\n"
"    float Width;\n"
"    float Height;\n"
