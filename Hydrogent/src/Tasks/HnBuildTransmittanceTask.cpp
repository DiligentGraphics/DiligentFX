...
HnBuildTransmittanceTask::HnBuildTransmittanceTask(pxr::HdSceneDelegate* ParamsDelegate, const pxr::SdfPath& Id) :
    HnTask{Id}
{
}

HnBuildTransmittanceTask::~HnBuildTransmittanceTask()
{
}

void HnBuildTransmittanceTask::Sync(pxr::HdSceneDelegate* Delegate,
...
void HnBuildTransmittanceTask::Prepare(pxr::HdTaskContext* TaskCtx,
                                       pxr::HdRenderIndex* RenderIndex)
{
    m_RenderIndex = RenderIndex;
}

void HnBuildTransmittanceTask::Execute(pxr::HdTaskContext* TaskCtx)
{
