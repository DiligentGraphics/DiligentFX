...
struct HnBuildTransmittanceTaskParams
{
    constexpr bool operator==(const HnBuildTransmittanceTaskParams& rhs) const
    {
        return true;
    }
    constexpr bool operator!=(const HnBuildTransmittanceTaskParams& rhs) const
...
class HnBuildTransmittanceTask final : public HnTask
{
public:
    HnBuildTransmittanceTask(pxr::HdSceneDelegate* ParamsDelegate, const pxr::SdfPath& Id);
    ~HnBuildTransmittanceTask();
