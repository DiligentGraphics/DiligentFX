...
struct HnEndOITPassTaskParams
{
    constexpr bool operator==(const HnEndOITPassTaskParams& rhs) const
    {
        return true;
    }
    constexpr bool operator!=(const HnEndOITPassTaskParams& rhs) const
...
{
public:
    HnEndOITPassTask(pxr::HdSceneDelegate* ParamsDelegate, const pxr::SdfPath& Id);
    ~HnEndOITPassTask();
