...
RADIENT_STATUS RadientSceneWriterImpl::SetMorph(RadientEntityID Entity, const RadientMorphComponent& Morph)
{
    return m_pState ? m_pState->SetMorph(Entity, Morph) : RADIENT_STATUS_INVALID_ARGUMENT;
}
