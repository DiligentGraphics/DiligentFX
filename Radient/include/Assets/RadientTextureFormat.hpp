...
// Converts every public Radient texture format to its Diligent equivalent.
...
#define RADIENT_TEXTURE_FORMAT_CASE(Fmt) \
    ...
    switch (Format)
    {
        ...
        RADIENT_TEXTURE_FORMAT_CASE(R8_SNORM);
        RADIENT_TEXTURE_FORMAT_CASE(RG8_SNORM);
        RADIENT_TEXTURE_FORMAT_CASE(RGBA8_SNORM);
        ...
        RADIENT_TEXTURE_FORMAT_CASE(R16_SNORM);
        RADIENT_TEXTURE_FORMAT_CASE(RG16_SNORM);
        RADIENT_TEXTURE_FORMAT_CASE(RGBA16_SNORM);
        ...
        RADIENT_TEXTURE_FORMAT_CASE(BC1_UNORM);
        RADIENT_TEXTURE_FORMAT_CASE(BC1_UNORM_SRGB);
        RADIENT_TEXTURE_FORMAT_CASE(BC2_UNORM);
        RADIENT_TEXTURE_FORMAT_CASE(BC2_UNORM_SRGB);
        RADIENT_TEXTURE_FORMAT_CASE(BC3_UNORM);
        RADIENT_TEXTURE_FORMAT_CASE(BC3_UNORM_SRGB);
        RADIENT_TEXTURE_FORMAT_CASE(BC4_UNORM);
        RADIENT_TEXTURE_FORMAT_CASE(BC4_SNORM);
        RADIENT_TEXTURE_FORMAT_CASE(BC5_UNORM);
        RADIENT_TEXTURE_FORMAT_CASE(BC5_SNORM);
        RADIENT_TEXTURE_FORMAT_CASE(BC6H_UF16);
        RADIENT_TEXTURE_FORMAT_CASE(BC6H_SF16);
        RADIENT_TEXTURE_FORMAT_CASE(BC7_UNORM);
        RADIENT_TEXTURE_FORMAT_CASE(BC7_UNORM_SRGB);
...
// Converts Diligent texture formats with a public Radient equivalent.
inline RADIENT_TEXTURE_FORMAT TextureFormatToRadient(TEXTURE_FORMAT Format)
{
#define RADIENT_TEXTURE_FORMAT_CASE(Fmt) \
    case TEX_FORMAT_##Fmt: return RADIENT_TEXTURE_FORMAT_##Fmt
    ...
    switch (Format)
    {
        ...
        default:
            return RADIENT_TEXTURE_FORMAT_UNKNOWN;
    }
