...
class RadientSceneAnimationDestinationImpl final : public IRadientAnimationDestination
{
public:
    explicit RadientSceneAnimationDestinationImpl(RadientSceneWriterImpl& Writer) noexcept :
        m_Writer{Writer}
    {}
...
private:
    RadientSceneWriterImpl& m_Writer;
};
