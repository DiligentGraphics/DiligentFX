...
///
/// Radient retains a copy of Desc and all metadata it references. Attribute
/// creation data is copied only into transient upload storage and is not kept
/// in CPU memory after the GPU upload has been scheduled.
