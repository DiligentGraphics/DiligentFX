...
public:
    struct RenderAttributes
    {
        ...
        const HLSL::CameraAttribs* pCurrCameraAttribs = nullptr;

        /// Previous camera settings
        const HLSL::CameraAttribs* pPrevCameraAttribs = nullptr;

        /// If this parameter is null, the effect will use its own buffer.
        IBuffer* pBufferCameraAttribs = nullptr;
...
public:
    ...
    IBuffer* GetBufferCameraAttribs() const;
