...
void PostFXContext::PrepareResources(const RenderAttributes& RenderAttribs)
{
    ...
    if (RenderAttribs.pBufferCameraAttribs == nullptr)
    {
        DEV_CHECK_ERR(RenderAttribs.pCurrCameraAttribs != nullptr, "RenderAttribs.pCurrCameraAttribs must not be null");
        DEV_CHECK_ERR(RenderAttribs.pPrevCameraAttribs != nullptr, "RenderAttribs.pPrevCameraAttribs must not be null");
        ...
        CameraAttibs[0] = *RenderAttribs.pCurrCameraAttribs;
        CameraAttibs[1] = *RenderAttribs.pPrevCameraAttribs;
    }
    else
    {
        m_Resources[RESOURCE_IDENTIFIER_CONSTANT_BUFFER] = RenderAttribs.pBufferCameraAttribs;
    }
...
IBuffer* PostFXContext::GetBufferCameraAttribs() const
{
